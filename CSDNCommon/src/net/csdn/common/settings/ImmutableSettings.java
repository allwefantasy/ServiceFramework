...
public class ImmutableSettings implements Settings {
     ...
     * settings implementation. Use {@link net.csdn.common.settings.ImmutableSettings#settingsBuilder()} in order to
     * construct it.
     */
    public static class Builder implements Settings.Builder {
        ...
        /**
         * Builds a {@link net.csdn.common.settings.Settings} (underlying uses {@link net.csdn.common.settings.ImmutableSettings}) based on everything
         * set on this builder.
         */
