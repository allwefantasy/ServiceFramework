...
import net.csdn.validate.impl.LengthParse;
...
public class JPABase implements Model {
    ...
    protected List validateParses = newArrayList(new PresenceParse(), new LengthParse(), new NumericalityParse(), new UniquenessParse());
