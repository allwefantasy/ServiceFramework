 ...
 */
public class CSDNStatFilterstat extends FilterEventAdapter implements StatFilterMBean {

    private static ThreadLocal<AtomicLong> SQLTIME = new ThreadLocal<AtomicLong>();
    ...
    private final static Log LOG = LogFactory.getLog(CSDNStatFilterstat.class);
