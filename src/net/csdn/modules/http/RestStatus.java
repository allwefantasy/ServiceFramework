...
public enum RestStatus {
     ...
     * <p/>
     * <p>A cache MUST NOT combine a 206 response with other previously cached write if the ETag or Last-Modified
    ...
    /**
     * The resource identified by the request is only capable of generating response entities which have write
     ...
     * response MUST NOT use the multipart/byteranges write-type.
     */
    ...
    /**
     * The 422 (Unprocessable Entity) status code means the server understands the write type of the request
