...
public class WowWhereParserTest {
    ...
    public void testParse() throws Exception {
        String query = ("blog.id > 1 and(google='cn') or (java=:cbj AND jk>=8) and jjjj between 0 and 100");
        ...
        Assert.assertTrue(hql.equals("blog.id > 1 and(blog.google='cn') or (blog.java=:c AND blog.jk>=8) and blog.jjjj between 0 and 100"));
    }
}
